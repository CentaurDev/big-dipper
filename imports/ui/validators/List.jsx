...
const ValidatorRow = (props) => {
    ...
    return <Card body>
        <SentryBoundary><Row className="validator-info">
            ...
            <Col className="voting-power data" xs={{size:8, offset:2}} md={{size:3, offset:0}} lg={2}><i className="material-icons d-md-none">power</i>  <span>{props.validator.voting_power?BigNumber(props.validator.voting_power).toFormat(0):0} ({props.validator.voting_power?(new BigNumber(props.validator.voting_power)).dividedBy(new BigNumber(props.totalPower)).times(100).toFormat(2):"0.00"}%)</span></Col>
